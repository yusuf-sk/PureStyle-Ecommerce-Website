...
const Cards = () => {
  ...
  return (
    <div className="min-h-screen bg-white md:py-4 mb-6 mt-6 md:mt-0">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl sm:text-4xl font-bold text-purple-800 mb-6 mt-4 text-center font-montserrat">
          Featured Products
        </h2>
              ...
              <div className="p-3 sm:p-4 transition-all duration-300 group-hover:-translate-y-1">
                ...
                <div className="flex items-center justify-between mt-1 sm:mt-2">
                  ...
                  <button
                    ...
                    className="p-1.5 sm:p-2 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition duration-300 font-poppins"
                  >
